...
class MenuItemSeeder extends Seeder
{
    ...
    {
        // Helper
        $add = function($title, $route = null, $type = 'link', $parent = null, $order = 0, $icon = null) {
        ...
        // Group: OFFER DETAILS
        $grpOffer = $add('OFFER DETAILS', null, 'link', null, 40);
        ...
        $grpMkt = $add('MARKETING DETAILS', null, 'link', null, 50);
        ...
        $grpDelivery = $add('DELIVERY DETAILS', null, 'link', null, 60);
        ...
        $grpFinance = $add('FINANCE DETAILS', null, 'link', null, 70);
        ...
        $grpReport = $add('FINANCE REPORT', null, 'link', null, 80);
        ...
        $catCal = $add('Festival Calendar', 'admin.getFestivalCalendar', 'link', null, 90);
    }
}
