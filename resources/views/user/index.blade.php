              ...
              <div class="row y-gap-20 justify-center text-center">
                <div class="col-auto">
                  <div class="sectionTitle -md">
                    ...
                    <p class=" sectionTitle__text mt-5 sm:mt-0">Use Traditional Ways For Your Spiritual Path With The Help Of Technology</p>
                  </div>
                </div>
              </div>
                ...
                <div data-anim-child="slide-up delay-1" class="row y-gap-20 justify-between items-end">
                  ...
                  <div class="col-auto">
                    <div class="tabs__controls row x-gap-10 justify-center js-tabs-controls">
                      ...
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button is-tab-el-active" data-tab-target=".-tab-item-1">Shiva Temple</button>
                      </div>
      
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-2">Maa Durga</button>
                      </div>
      
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-3">Vishnu Bhagwan</button>
                      </div>
      
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-4">Surya Devta</button>
                      </div>
      
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-5">Ganesh </button>
                      </div>
      
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-6">Kartikayen</button>
                      </div>
      
                      <div class="col-auto">
                        <button class="tabs__button text-14 fw-500 px-20 py-10 rounded-4 bg-light-2 js-tabs-button " data-tab-target=".-tab-item-7">Hanuman</button>
                      </div>
            ...
            <div class="container">
              <div class="row y-gap-60">
                <div class="col-xl-5 col-lg-6">
                  ...
                  <p class="text-white mt-20">We are using Technology to revive the hundreds of years old method of having a peaceful and happy darshan for the religious travellers .</p>
                      ...
                      <div class="swiper-slide">
                        <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40 shadow-2">
                          <div class="">
                            ...
                            <p class="testimonials__text lh-18 fw-500 text-dark-1">&quot;Our family was traveling to Odisha and we had no idea of getting a good visit to Puri. Then we came across 33Crores. They made the visit so easy and the religious trip was fantastic.&quot;</p>
                      ...
                      <div class="swiper-slide">
                        <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40 shadow-2">
                          <div class="">
                            ...
                            <p class="testimonials__text lh-18 fw-500 text-dark-1">&quot;We wanted to have a visit to Puri Temple, some one told us about 33Crores. It was really magical to know that we had a dedicated Sebayat for our city, who took all of us around the temple and we were delighted to see our ancestors visits to the Devine place&quot;</p>
                      ...
                      <div class="swiper-slide">
                        <div class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40 shadow-2">
                          <div class="">
                            ...
                            <p class="testimonials__text lh-18 fw-500 text-dark-1">&quot;We reached Lingaraj Temple a Priest was ready to guide us and showed us the temple. We had heard priest of Odisha were harsh but its not true. We felt as if we were the part of the Culture. Infact the online service of 33 Crores is the best and should be implemeted in all temples across India &quot;</p>
            ...
            <div class="container">
              <div class="row y-gap-30 items-center justify-between">
                <div data-anim-child="slide-up delay-2" class="col-xl-5 col-lg-6">
                  ...
                  <p class="text-dark-1 pr-40 lg:pr-0 mt-15 sm:mt-5">Book in advance or last-minute with 33Crores. Receive instant confirmation. Access your booking info offline.</p>
                  ...
                  <div class="row y-gap-20 items-center pt-30 sm:pt-10">
                    ...
                    <div class="col-auto">
                      <a href="https://play.google.com/store/apps/details?id=com.croresadmin.shopifyapp" target="_blank" class="d-flex items-center px-20 py-10 rounded-8 border-white-15 text-white bg-dark-3">
