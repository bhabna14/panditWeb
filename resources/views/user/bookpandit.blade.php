@extends('user.layouts.front')
          ...
          <div class="row">
            <div class="col-12">
              <div class="text-center">
                <h1 class="text-30 fw-600">Find Your Sevayat By Location</h1>
                <br>
          <!-------------------------------Filter Code--------------------------------->	 
    ...
    <div class="form-group col-4  mb-3">
      <select class="form-control  form-input lh-1 text-18 text-center -outline-blue-1 h-50 ml-20" id="inputState"
    ...
    <div class="form-group col-4  mb-3 form-input"> 
      <select class="form-control lh-1 text-18 text-center -outline-blue-1 h-50 ml-20" id="inputDistrict" 	style=" border-color: var(--color-blue-1);border: 1px solid var(--color-border);
      border-radius: 4px;
      padding: 0;
      min-height: 70px;
      transition: all .2s cubic-bezier(.165,.84,.44,1);">
    ...
    <div class="form-group col-4  mb-3 form-input"> 
      <select class="form-control lh-1 text-18 text-center -outline-blue-1 h-50 ml-20" id="inputCity" 	style=" border-color: var(--color-blue-1);border: 1px solid var(--color-border);
      border-radius: 4px;
      padding: 0;
      min-height: 70px;
      transition: all .2s cubic-bezier(.165,.84,.44,1);">
          <option value="">--Select Locality -- </option>
                          ...
                          <option value=" Valparai (SC)"> Valparai (SC)</option>
                ...
                <div class="col-12">
                  ...
                  <div class="border-top-light pt-30">
                      ...
                      <div class="col-md-auto">
                        ...
                        <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                          <div class="cardImage__content">
                            ...
                            <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/hotel/1/1.png" alt="image">
                    ...
                    <div class="text-14 text-light-1 mt-5"></div>
                          ...
                          <a href="https://rzp.io/l/sebayat" class="button -md -dark-1 bg-blue-1 text-white mt-24">
                      ...
                      <div class="col-md-auto">
                        ...
                        <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                          <div class="cardImage__content">
                            ...
                            <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/hotel/1/3.png" alt="image">
                      ...
                      <div class="col-md-auto">
                        ...
                        <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                          <div class="cardImage__content">
                            ...
                            <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/hotel/1/2.png" alt="image">
                      ...
                      <div class="col-md-auto">
                        ...
                        <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                          <div class="cardImage__content">
                            ...
                            <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/hotel/1/4.png" alt="image">
                      ...
                      <div class="col-md-auto">
                        ...
                        <div class="cardImage ratio ratio-1:1 w-250 md:w-1/1 rounded-4">
                          <div class="cardImage__content">
                            ...
                            <img class="rounded-4 col-12 js-lazy" src="#" data-src="img/lists/hotel/1/6.png" alt="image">
