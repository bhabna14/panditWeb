                    ...
                    <div class="col-md-12">
                        <div class="order-history-sec">
                            <div class="order-details">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        {{ \Carbon\Carbon::parse($order->subscription->start_date)->format('Y-m-d') }}
                            ...
                            <div class="row order-details-booking">
                                <div class="col-md-2">
                                    <img src="{{ $order->flowerProduct->product_image_url }}" alt="Product Image" />
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('subscription.details', ['order_id' => $order->order_id]) }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="pauseForm">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="date" id="pause_start_date" name="pause_start_date"
                                                        required>
                                                </div>
                                                <div>
                                                    <label for="pause_end_date">Pause End Date</label>
                                                    <input type="date" id="pause_end_date" name="pause_end_date"
                                                        required>
                                                </div>
                                                <p class="text-muted">
                                                    Dates must be between <span id="subscriptionStart"></span> and <span
                            ...
                            @if ($order->subscription->status === 'paused')
                                <div class="highlighted-text mt-2">
                                    ...
                                    <span
                                        class="text-highlight">{{ \Carbon\Carbon::parse($order->subscription->pause_start_date)->format('Y-m-d') }}</span>
                                    to
                                    <span
                                        class="text-highlight">{{ \Carbon\Carbon::parse($order->subscription->pause_end_date)->format('Y-m-d') }}</span>.
                                </div>
                            @endif
                        </div>
