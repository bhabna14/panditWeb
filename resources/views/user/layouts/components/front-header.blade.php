...
<<<<<<< Updated upstream
              <a href="{{url('pandit/panditlogin')}}" class="button px-10 fw-300 -blue-1 h-50 " style="   font-size: 15px;
=======
              <a href="{{ url('pandit/panditlogin') }}" target="_blank" class="button px-10 fw-300 -blue-1 h-50 " style="   font-size: 15px;
>>>>>>> Stashed changes
    color: #000;
