@extends('user.layouts.app')
    ...
    @section('content')
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                         ...
                                         <input type="hidden" class="form-control" id="exampleInputEmail1" name="userid" value="{{ $userinfo->userid ?? "" }}" placeholder="Enter First Name">
                                            ...
                                            <form action="{{  url('user/updatechildInfo') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                {{-- @method('PUT') --}}
                                            ...
                                            <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                                ...
                                                @foreach($childinfos as $index => $childinfo)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('user/updatechildstatus/'.$childinfo->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td></td>
                                                    </tr>
                    ...
                    <form action="{{  route('updateIdInfo', $userinfo->id) }}" method="post" enctype="multipart/form-data">
                                           ...
                                           <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                            ...
                                            @foreach($iddetails as $index => $iddetail)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('user/updateIdstatus/'.$iddetail->id)}}" onclick="return confirm('Are you sure to delete?')" ><i class="fa fa-trash" aria-hidden="true"></i></a></td></td>
                                                </tr>
                        ...
                        @else
                        <form action="{{  url('user/updatenewAddress') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                             <div class="row">
                                <div class="col-lg-12 col-md-12">
                       ...
                       @endif
                        ...
                        @else
                        <form action="{{  url('user/updateBankInfo') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                             <div class="row">
                                <div class="col-lg-12 col-md-12">
