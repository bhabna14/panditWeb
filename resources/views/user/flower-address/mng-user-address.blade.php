                        ...
                        <div class="single-address">
                            <div class="rounded-4 bg-white shadow-3 position-relative">
                                ...
                                <div class="address-details">
                                    <strong>Address:</strong> {{ $address->apartment_flat_plot ?? '' }},
                                    {{ $address->localityDetails->locality_name ?? ('N/A' ?? '') }}<br>
                                ...
                                <div class="action-btns">
                                    ...
                                    @else
                                        <a href="{{ route('removeaddress', $address->id) }}"
                                            onclick="return confirm('Are you sure you want to remove this address?')">Remove</a>
                                    @endif
                                    |
                                    @if (!$address->default)
