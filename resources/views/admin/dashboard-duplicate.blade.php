            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('flower.customize.request', ['filter' => 'upcoming']) }}" target="_blank">
                        <div class="card sales-card card-theme-indigo"  style="background: linear-gradient(135deg, #9793f2 0%, #c9eaf9 40%, #d4dce7 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'end']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-ends-today"  style="background: linear-gradient(135deg, #f3aced 0%, #fab7f7 40%, #ecc2e6 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'fivedays']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-five-days"  style="background: linear-gradient(135deg, #f3aced 0%, #fab7f7 40%, #ecc2e6 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'expired']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-renew-pending" style="background: linear-gradient(135deg, #f3aced 0%, #fab7f7 40%, #ecc2e6 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'rider']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-assign-rider" style="background: linear-gradient(135deg, #f3aced 0%, #fab7f7 40%, #ecc2e6 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'todayrequest']) }}" target="_blank">
                        <div class="card sales-card paused-card-1"  style="background: linear-gradient(135deg, #aaf3a7 0%, #b4ee9d 40%, #d3f0d5 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'paused']) }}" target="_blank">
                        <div class="card sales-card paused-card-2"  style="background: linear-gradient(135deg, #aaf3a7 0%, #b4ee9d 40%, #d3f0d5 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'tomorrow']) }}" target="_blank">
                        <div class="card sales-card paused-card-3"  style="background: linear-gradient(135deg, #aaf3a7 0%, #b4ee9d 40%, #d3f0d5 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'nextdayresumed']) }}" target="_blank">
                        <div class="card sales-card paused-card-4"  style="background: linear-gradient(135deg, #aaf3a7 0%, #b4ee9d 40%, #d3f0d5 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
