    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="category" id="category" class="form-control select2" required>
                ...
                <option value="Subscription"      {{ $currentCat == 'Subscription' ? 'selected' : '' }}>Subscription</option>
                <option value="Flower"            {{ $currentCat == 'Flower' ? 'selected' : '' }}>Flower</option>
                <option value="Immediateproduct"  {{ $currentCat == 'Immediateproduct' ? 'selected' : '' }}>Customize Flower</option>
                <option value="Customizeproduct"  {{ $currentCat == 'Customizeproduct' ? 'selected' : '' }}>Customize Product</option>
        ...
        <div class="col-md-4 mb-3" id="durationField" style="{{ $isSubscription ? '' : 'display:none;' }}">
            ...
            <select name="duration" id="duration" class="form-control select2">
                <option value="" {{ old('duration', $product->duration) === null ? 'selected' : '' }}>— Select —</option>
                <option value="1" {{ (string)old('duration', $product->duration) === '1' ? 'selected' : '' }}>1</option>
                <option value="3" {{ (string)old('duration', $product->duration) === '3' ? 'selected' : '' }}>3</option>
                <option value="6" {{ (string)old('duration', $product->duration) === '6' ? 'selected' : '' }}>6</option>
            </select>
        </div>
                ...
                @for ($i = 0; $i < $rowsCount; $i++)
                    ...
                    <div class="row mb-3 package-row align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="quantity[]" min="0" step="any" value="{{ $qty }}" placeholder="0" required>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" name="item_price[]" min="0" step="0.01" value="{{ $price }}" placeholder="0.00" required>
                        </div>
                    </div>
                @endfor
            </div>
...
(function() {
    ...
    function applyCategoryUI() {
        ...
        // Subscription-only fields: per-day price + duration
