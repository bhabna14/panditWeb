                        ...
                        <div class="row mb-3 package-row align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" name="quantity[]" min="0" step="any"
                                       value="{{ $oldQtys[$i] ?? '' }}" placeholder="0" required>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" name="item_price[]" min="0" step="0.01"
                                       value="{{ $oldPrices[$i] ?? '' }}" placeholder="0.00" required>
                            </div>
                        </div>
                    @endforeach
                    ...
                    @foreach ($preparedPackage as $row)
                        <div class="row mb-3 package-row align-items-end">
                            ...
                            <div class="col-md-2">
                                <label class="form-label">Qty</label>
                                <input type="number" class="form-control" name="quantity[]" min="0" step="any"
                                       value="{{ $row['quantity'] ?? '' }}" placeholder="0" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Unit</label>
                                <select class="form-control select2 unit-select" name="unit_id[]" required>
                            ...
                            <div class="col-md-3">
                                <label class="form-label">Item Price (Rs.)</label>
                                <input type="number" class="form-control" name="item_price[]" min="0" step="0.01"
                                       value="{{ $row['price'] ?? '' }}" placeholder="0.00" required>
                            </div>
                        </div>
                    @endforeach
                @else
...
(function(){
    ...
    function updateFlowerDateRequirements(){
        const cat = $category.val();
        if (cat !== 'Flower') {
            $fromInput.prop({required:false, disabled:false});
            $toInput.prop({required:false, disabled:false});
            return;
        }
