                    ...
                    <div class="my-md-auto mt-4 prof-details">
                        ...
                        <p class="text-muted ms-md-4 ms-0 mb-2">
                            <span><i class="fa fa-phone me-2"></i></span><span
                                class="font-weight-semibold me-2">:</span><span>{{ $user->mobile_number }}</span>
                        </p>
                        <p class="text-muted ms-md-4 ms-0 mb-2">
                            <span><i class="fa fa-envelope me-2"></i></span><span
                                class="font-weight-semibold me-2">:</span><span>{{ $user->email }}</span>
                        </p>
                        <p class="text-muted ms-md-4 ms-0 mb-2">
                            <span><i class="fa fa-venus-mars me-2"></i></span><span
                                class="font-weight-semibold me-2">:</span><span>{{ $user->gender }}</span>
                        </p>
                    </div>
                    <div class="my-md-auto mt-4 prof-details">
                                                ...
                                                <tbody>
                                                    @foreach ($orders as $order)
                                                        <tr>
                                                            ...
                                                            <td>{{ $order->start_date ?? 'NA' }}

                                                            </td>
                                                            <td>{{ $order->flowerProducts->name }} <br>
                                                                ({{ \Carbon\Carbon::parse($order->start_date)->format('F j, Y') ?? 'NA' }}
                                                                -
                                                                {{ $order->new_date ? \Carbon\Carbon::parse($order->new_date)->format('F j, Y') : \Carbon\Carbon::parse($order->end_date)->format('F j, Y') }})
                                                            </td>

                                                            {{-- <td>{{ $order->total_price }}</td> --}}
                                                            <td>{{ number_format($order->order->total_price, 2) }}</td>
                                                ...
                                                <div class="card mb-3 shadow-sm border-secondary">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text mb-2">
                                                            ...
                                                            {{ $order->order->address->localityDetails->locality_name ?? '' }}<br>
                                                            <strong>Apartment:</strong>
                                                            {{ $order->order->address->apartment_name ?? '' }}<br>
                                                            <strong>Landmark:</strong>
                                                            {{ $order->order->address->landmark ?? '' }}<br>
                                                            <strong>City:</strong>
