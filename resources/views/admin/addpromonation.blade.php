...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">ADD PROMONATION</span>
        </div>
        <div class="justify-content-center mt-2">
            <ol class="breadcrumb d-flex justify-content-between align-items-center">
                ...
                <li class="breadcrumb-item active tx-15" aria-current="page">ADD PROMONATION</li>
            </ol>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <form action="{{ route('savepromonation') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
