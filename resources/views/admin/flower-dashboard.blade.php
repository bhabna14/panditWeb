            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'fivedays']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-five-days"  style="background: linear-gradient(135deg, #feb9b9 0%, #fd9db0 40%, #f9e3e9 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'expired']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-renew-pending" style="background: linear-gradient(135deg, #f8baba 0%, #fd9db0 40%, #f9e3e9 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-xs-12 mb-3">
                    <a href="{{ route('admin.orders.index', ['filter' => 'rider']) }}" target="_blank">
                        <div class="card sales-card sub-status-card-assign-rider" style="background: linear-gradient(135deg, #f2b8b8 0%, #fd9db0 40%, #f9e3e9 100%) !important;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
