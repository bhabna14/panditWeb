...
@section('content')
    <div class="container py-4">
        ...
        <div class="tab-content" id="sectionsContent">
            @php
                // Subscriptions table (Tomorrow Delivery & Resume)
                ...
                // Customize Orders table (FlowerRequest for tomorrow)
            ...
            {{-- Tab 2: Tomorrow Customize Orders --}}
