...
<form method="GET" action="{{ route('admin.reports.flower_compare') }}" class="card card-soft p-3 mb-3">
    <div class="row gy-2">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="user_id" class="form-control" value="{{ $userId }}" placeholder="Optional filter">
        </div>
...
@php
    function cmpTotalsChips($t){
        return '
          <div class="hstack">
            <div class="chip">Est Qty: <span class="amount">'.number_format($t['est_qty'],2).'</span></div>
            <div class="chip">Act Qty: <span class="amount">'.number_format($t['act_qty'],2).'</span></div>
            <div class="chip '.($t['diff_qty']>=0?'good':'bad').'">Δ Qty: <span class="amount">'.number_format($t['diff_qty'],2).'</span></div>
            ...
            <div class="chip '.($t['diff_value']>=0?'good':'bad').'">Δ Value: <strong class="amount">₹ '.number_format($t['diff_value'],2).'</strong></div>
          </div>';
    }
@endphp
