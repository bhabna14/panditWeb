                                    ...
                                    <tr data-row>
                                        ...
                                        <td>
                                            ...
                                            @if (!$flowerVal && ($default['flower_name'] ?? null))
                                                <small class="text-muted ms-1">Unmatched:
                                                    {{ $default['flower_name'] }}</small>
                                            @endif
                                        ...
                                        <td>
                                            <input type="number" class="form-control readonly-input" data-est-qty-display
                                                disabled value="{{ $qtyVal ?? $estQtyVal }}">
                                            <input type="hidden" name="est_quantity[]"
