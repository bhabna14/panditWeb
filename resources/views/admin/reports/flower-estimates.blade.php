        ...
        <div class="container py-4">
            <div class="sticky-top-filter bg-light pb-3">
                ...
                <form class="card card-body shadow-sm" method="get" action="{{ route('admin.flowerEstimate') }}">
                    ...
                    <small class="text-muted mt-2">Tip: leave both dates same to estimate for a single day (defaults to
                        today).</small>
                </form>
            </div>
                            ...
                            <h2 class="accordion-header" id="{{ $dayId }}-header">
                                <button class="accordion-button {{ $loop->first ? '' : 'collapsed' }}" type="button"
                                    ...
                                    <div class="d-flex w-100 justify-content-between align-items-center">
                                        ...
                                        <span class="badge bg-success fs-6">Grand Total: <span
                                                class="money">₹{{ number_format($grand, 2) }}</span></span>
                                    </div>
                                </button>
                            </h2>
                            <div id="{{ $dayId }}-body"
                                                            ...
                                                            <div class="table-responsive mt-3">
                                                                <table class="table table-sm table-hover align-middle">
                                                                    ...
                                                                    <tbody>
                                                                        @forelse($items as $it)
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-end money">
                                                                                    {{ number_format($it['per_item_price'], 2) }}
                                                                                </td>
                                                                                <td class="text-end">
                                                                                    {{ rtrim(rtrim(number_format($it['total_qty'], 3), '0'), '.') }}
                                                                                </td>
                                                                                <td class="text-end money">
                                                                        ...
                                                                        @empty
                                                                            <tr>
                                                                                <td colspan="6" class="text-muted">No
                                                                                    package items configured for this
                                                                                    product.</td>
                                                                            </tr>
                                                                        @endforelse
                                                                    </tbody>
