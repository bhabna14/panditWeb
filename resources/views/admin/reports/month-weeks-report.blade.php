                                ...
                                <table class="table table-sm table-striped table-hover align-middle mb-2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="{{ 1 + max(count($deliveryCols), 1) }}" class="text-center pe-3">Rider Deliveries</th>
                                        </tr>
                                        <tr>
                                            <th>Incm</th>
                                            <th>Purch</th>
                                            ...
                                            @forelse($deliveryCols as $r)
                                                {{-- Show only first 4 letters, keep full name in tooltip --}}
...
@push('scripts')
    ...
    <script>
        ...
        // Init tooltips (for rider full names)
