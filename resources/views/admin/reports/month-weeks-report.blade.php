...
@section('styles')
    ...
    <style>
        ...
        .colorful-metrics-table thead_toggle tr:nth-child(2) th.col-vendor.vendor-odd,
...
@php
    ...
    // Ensure these are always countable
    $weeks = $weeks ?? [];
...
{{-- ========= MODAL: Income Users List (UPDATED: shows Payment Method) ========= --}}
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between align-items-center mb-2 gap-2">
                    ...
                    <input type="text" class="form-control form-control-sm" style="max-width: 260px"
                           id="incomeUsersSearch" placeholder="Search name / id / method...">
                </div>
...
<script>
    ...
    function getPaymentMethodText(u) {
        // Controller can send: payment_methods (grouped) or payment_method (single)
    ...
    function renderUsers(users, q = '') {
        ...
        const filtered = query
            ? users.filter(u => {
                ...
                return name.includes(query) || uid.includes(query) || pm.includes(query);
            })
            : users;
    ...
    document.addEventListener('click', (e) => {
        ...
        // Sort desc by amount (stable display)
