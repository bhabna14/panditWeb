        ...
        <div class="nu-tabs p-3">
            <ul class="nav nav-pills nu mb-3" id="reportTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="tab-month" data-bs-toggle="pill" data-bs-target="#pane-month"
                            type="button" role="tab" aria-controls="pane-month" aria-selected="true" data-color="violet">
                        Month Report
                        <span class="badge bg-light text-dark ms-1">{{ \Carbon\Carbon::createFromDate($year, $month, 1)->format('M Y') }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="tab-weeks" data-bs-toggle="pill" data-bs-target="#pane-weeks"
                            type="button" role="tab" aria-controls="pane-weeks" aria-selected="false" data-color="cyan">
                        Weekly Report
            ...
            <div class="tab-content" id="reportTabsContent">
                {{-- ======================= MONTH TAB ======================= --}}
                <div class="tab-pane fade show active" id="pane-month" role="tabpanel" aria-labelledby="tab-month" tabindex="0">
                ...
                {{-- ======================= WEEKS TAB ======================= --}}
                <div class="tab-pane fade" id="pane-weeks" role="tabpanel" aria-labelledby="tab-weeks" tabindex="0">
...
@push('scripts')
    ...
    <script>
        ...
        function setAll(open) {
            document.querySelectorAll('#pane-weeks #monthAccordion .accordion-collapse').forEach(el => {
        ...
        // Activate correct tab if hash is provided (#weeks or #month)
