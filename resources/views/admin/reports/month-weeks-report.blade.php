...
@section('styles')
    {{-- If your admin layout already loads Bootstrap 5 CSS, you can remove this CDN line --}}
...
<div class="container-fluid page-wrap">
    ...
    {{-- ===== your tabs + tables remain the same as your current file ===== --}}
    {{-- Keep your existing Weeks and Month tab markup exactly as-is --}}
    {!! '' !!}
    {{-- For brevity: paste your existing tab/table markup here (unchanged) --}}
</div>
...
{{-- IMPORTANT: Bootstrap JS must exist. If your admin layout already loads it, remove this CDN line. --}}
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>

<script>
(function () {
    // Guard: if Bootstrap JS is not loaded, modal cannot work.
    if (!window.bootstrap) {
        console.error('Bootstrap JS is missing. Ensure bootstrap.bundle.min.js is loaded.');
        return;
    }
    ...
    modalEl.addEventListener('hidden.bs.modal', () => {
        ...
        if (countEl) countEl.textContent = 'Customers: 0';
