...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.saveFlowerPickupAssignRider') }}" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" id="delivery_date" name="delivery_date"
                            ...
                            value="{{ old('delivery_date', now()->toDateString()) }}" min="{{ now()->toDateString() }}"
                            required>
                        @error('delivery_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
        ...
        @php
            ...
            $rowCount = max(count($oldFlowerIds), count($oldUnitIds), count($oldQtys), count($oldPrices));
        @endphp
