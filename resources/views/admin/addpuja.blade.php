    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="justify-content-center mt-2">
            <ol class="breadcrumb d-flex justify-content-between align-items-center">
                <li class="breadcrumb-item tx-15"><a href="{{ url('admin/manage-puja') }}" class="btn btn-warning text-dark">Manage Puja</a></li>
                <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Dashboard</a></li>
                <li class="breadcrumb-item active tx-15" aria-current="page">ADD PUJA</li>
            </ol>
        </div>
    </div>
    <!-- /breadcrumb -->
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="event_name">Puja Imgae</label>
                                    <input type="file" class="form-control" id="puja_img" name="puja_img" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
