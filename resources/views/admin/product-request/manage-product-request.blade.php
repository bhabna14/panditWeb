                                                ...
                                                @foreach($pendingRequests as $request)
                                                    <tr>
                                                        <td>{{ $request->request_id }} <br>
                                                            Name: {{ $request->user ? $request->user->name : 'N/A' }} <br>
                                                            Number: {{ $request->user ? $request->user->mobile_number : 'N/A' }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                            <form action="{{ route('admin.saveProductOrder', $request->id) }}" method="POST">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <label for="requested_flower_price">Requested Flower Price</label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <small class="form-text text-muted">If the delivery charge is 0, please enter "0".</small>
                                                                </div>
                                                        ...
                                                        <td>
                                                            <form id="markPaymentForm_{{ $request->request_id }}" 
                                                                  action="{{ route('admin.markProductPayment', $request->request_id) }}" 
                                                                  method="POST" 
