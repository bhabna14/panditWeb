                                        ...
                                        <table id="file-datatable" class="table table-bordered ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style = 'color:#B7070A;font-size: 15px'><a class ='cursor-pointer' href="{{url('admin/edit-youtube/'.$youtube->id)}}"><i class="fa fa-edit"></i></a> | <a class ='cursor-pointer' href="{{url('admin/delete-youtube/'.$youtube->id)}}"  onclick="return confirm('Are you sure to delete?')" ><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                                @endforeach
