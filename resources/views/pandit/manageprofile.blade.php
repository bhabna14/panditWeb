                ...
                <div class="card-body d-md-flex">
                    <div class="">
                        <span class="profile-image pos-relative">
                            <img class="br-5" alt="" src="{{ asset($pandit_profile->profile_photo) }}"
                                alt="profile">
                    ...
                    <div class="main-content-body tab-pane border-top-0 active" id="edit">
                        <div class="card">
                            <div class="card-body border-0">
                                ...
                                @endif
                                <form class="form-horizontal" action="{{ route('updateProfile', $pandit_profile->id) }}"
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control" id="whatsappno" name="whatsappno"
                                                    value="{{ $pandit_profile->whatsappno }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" id="bloodgroup" name="bloodgroup">
                                                    ...
                                                    <option value="A+"
                                                        {{ $pandit_profile->bloodgroup == 'A+' ? 'selected' : '' }}>A+
                                                    </option>
                                                    <option value="A-"
                                                        {{ $pandit_profile->bloodgroup == 'A-' ? 'selected' : '' }}>A-
                                                    </option>
                                                    <option value="B+"
                                                        {{ $pandit_profile->bloodgroup == 'B+' ? 'selected' : '' }}>B+
                                                    </option>
                                                    <option value="B-"
                                                        {{ $pandit_profile->bloodgroup == 'B-' ? 'selected' : '' }}>B-
                                                    </option>
                                                    <option value="AB+"
                                                        {{ $pandit_profile->bloodgroup == 'AB+' ? 'selected' : '' }}>AB+
                                                    </option>
                                                    <option value="AB-"
                                                        {{ $pandit_profile->bloodgroup == 'AB-' ? 'selected' : '' }}>AB-
                                                    </option>
                                                    <option value="O+"
                                                        {{ $pandit_profile->bloodgroup == 'O+' ? 'selected' : '' }}>O+
                                                    </option>
                                                    <option value="O-"
                                                        {{ $pandit_profile->bloodgroup == 'O-' ? 'selected' : '' }}>O-
                                                    </option>
                                            ...
                                            <div class="col-md-3">
                                                <label class="rdiobox">
                                                    <input name="marital" type="radio" value="Married"
                                                        {{ $pandit_profile->maritalstatus == 'Married' ? 'checked' : '' }}>
                                                    <span>Married</span>
                                                </label>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="rdiobox">
                                                    <input name="marital" type="radio" value="Unmarried"
                                                        {{ $pandit_profile->maritalstatus == 'Unmarried' ? 'checked' : '' }}>
                                                    <span>Unmarried</span>
                                                </label>
                                            </div>
                                        </div>
                                                    ...
                                                    <select class="form-control select2" id="language" name="language[]"
                                                        ...
                                                        @foreach ($languages as $language)
                                                            <option value="{{ $language }}"
                                                                {{ in_array($language, $pandit_profile->language) ? 'selected' : '' }}>
                                                                {{ $language }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="form-group ">
                                        <div class="row row-sm">
                                            <div class="col-md-3">
                                                <label class="form-label" for="about">About Pandit</label>
                                            </div>
                                            <div class="col-md-9">
                                                <textarea class="form-control" name ="about" id = "about">{{ $pandit_profile->about_pandit }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="main-content-body tab-pane border-top-0" id="career">
                        <div class="card">
                            <div class="card-body border-0">
                                ...
                                @endif
                                <form class="form-horizontal" action="{{ route('updateCareer', $pandit_career->id) }}"
                                    method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="qualification"
                                                    value="{{ $pandit_career->qualification }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control" name="experience"
                                                    value="{{ $pandit_career->total_experience }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="upload_id[]"
                                                        id="upload_id" multiple>
                                                </div>
                                            </div>
                                                        ...
                                                        @if ($pandit_idcard->upload_id != '')
                                                            <tr>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    {{ $index + 1 }}</td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    {{ $pandit_idcard->id_type }}</td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    <img src="{{ asset(asset('uploads/id_proof/' . $pandit_idcard->upload_id)) }}"
                                                                        style="width:80px; height:40px" alt="" />
                                                                </td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    <a style="font-size: 25px;color: red"
                                                                        href="{{ url('/pandit/deletIdproof/' . $pandit_idcard->id) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="upload_edu[]"
                                                        id="upload_edu" multiple>
                                                </div>
                                            </div>
                                            <div class="col-md-1" style="margin-top: 27px">
                                                <div class="form-group">
                                                        ...
                                                        @if ($pandit_education->upload_education != '')
                                                            <tr>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    {{ $index + 1 }}</td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    {{ $pandit_education->education_type }}</td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    <img src="{{ asset(asset('uploads/edu_details/' . $pandit_education->upload_education)) }}"
                                                                        style="width:80px; height:40px" alt="" />
                                                                </td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    <a style="font-size: 25px;color: red"
                                                                        href="{{ url('/pandit/deletEducation/' . $pandit_education->id) }}"
                                                                        onclick="return confirm('Are you sure to delete?')"><i
                                                                            class="fa fa-trash"
                                                                            aria-hidden="true"></i></a>
                                                                </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="vedic_type[]"
                                                        id="vedic_type" placeholder="Enter Vedic">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label for="upload_vedic">Upload</label>
                                                    <input type="file" class="form-control" name="upload_vedic[]"
                                                        id="upload_vedic" multiple>
                                                </div>
                                            </div>
                                            <div class="col-md-1" style="margin-top: 27px">
                                                <div class="form-group">
                                                        ...
                                                        @if ($pandit_vedic->upload_vedic != '')
                                                            <tr>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    {{ $index + 1 }}</td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    {{ $pandit_vedic->vedic_type }}</td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    <img src="{{ asset(asset('uploads/vedic_details/' . $pandit_vedic->upload_vedic)) }}"
                                                                        style="width:80px; height:40px" alt="" />
                                                                </td>
                                                                <td style='text-align: center;font-weight: bold'>
                                                                    <a style="font-size: 25px;color: red"
                                                                        href="{{ url('/pandit/deletVedic/' . $pandit_vedic->id) }}"
                                                                        onclick="return confirm('Are you sure to delete?')"><i
                                                                            class="fa fa-trash"
                                                                            aria-hidden="true"></i></a>
                                                                </td>
