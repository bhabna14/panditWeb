                ...
                <div class="card-footer py-0">
                    <div class="profile-tab tab-menu-heading border-bottom-0">
                        <nav class="nav main-nav-line p-0 tabs-menu profile-nav-line border-0 br-5 mb-0 full-width-tabs">
                            <a class="nav-link mb-2 mt-2 active" data-bs-toggle="tab" href="#profile"
                                onclick="changeColor(this)">Profile</a>
                            <a class="nav-link mb-2 mt-2" data-bs-toggle="tab" href="#career"
                                onclick="changeColor(this)">Career</a>
                            <a class="nav-link mb-2 mt-2" data-bs-toggle="tab" href="#skill"
                            ...
                            <a class="nav-link mb-2 mt-2" data-bs-toggle="tab" href="#bank"
                                onclick="changeColor(this)">Bank Details</a>
                            <a class="nav-link mb-2 mt-2" data-bs-toggle="tab" href="#address"
                                onclick="changeColor(this)">Address Details</a>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <input type="hidden" class="form-control"
                                                                id="exampleInputEmail1" name="userid" value=""
                                ...
                                <form class="form-horizontal" action="" method="post"
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" id="career_id" name="career_id"
                                            value="CR{{ rand(1000, 9999) }}" placeholder="">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Highest Qualification</label>
                                                    <input type="text" class="form-control" name="qualification"
                                                        id="qualification" placeholder="Enter Heighest Qualification">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="experience"
                                                        id="experience" placeholder="Total Experience">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-md-2" style="margin-top: 27px">
                                                                <div class="form-group">
                                                                    <button type="button"
                                                                        ...
                                                                        onclick="addIdSection()">Add More</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="">
                                                    <div id="show_edu_item">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Educational
                                                                        Qualification</label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1">Upload
                                                                        Document</label>
                                                                    <input type="file" class="form-control"
                                                                        name="uploadEducation[]" id="uploadEducation"
                                                                        placeholder="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2" style="margin-top: 27px">
                                                                <div class="form-group">
                                                                    <button type="button"
                                                                        class="btn btn-success add_item_btn"
                                                                        onclick="addEduSection()">Add More</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="">
                                                    <div id="show_vedic_item">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">Vedic
                                                                        certificate</label>
                                                                    <select name="idproof[]" class="form-control"
                                                                        id="">
                                                                        <option value=" ">Select..</option>
                                                            ...
                                                            <div class="col-md-2" style="margin-top: 27px">
                                                                <div class="form-group">
                                                                    <button type="button"
                                                                        class="btn btn-success add_item_btn"
                                                                        onclick="addVedicSection()">Add More</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="preaddress" value=""
                                                                            id="preaddress" placeholder="Enter Address">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="predistrict" value=""
                                                                            id="predistrict" placeholder="Enter District">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="precountry" value="India"
                                                                            id="precountry" placeholder="Enter Country">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="prepincode" value=""
                                                                            id="prepincode" placeholder="Enter Pincode">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="prelandmark" value=""
                                                                            id="prelandmark" placeholder="Enter Landmark">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <label class="ckbox"><input type="checkbox" id="same"
                                                                    onchange="addressFunction()"> <span
                                                                    class="mg-b-10">Same as Present Address</span></label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="peraddress" value=""
                                                                            id="peraddress" placeholder="Enter Address">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="perdistri" value=""
                                                                            id="perdistri" placeholder="Enter District">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="percountry" value=""
                                                                            id="percountry" placeholder="Enter Country">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="perpincode" value=""
                                                                            id="perpincode" placeholder="Enter Pincode">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
