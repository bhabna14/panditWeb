                    ...
                    <div
                        ...
                        <div class="card-sigin mt-5 mt-md-0">
                            ...
                            <div class="main-card-signin d-md-flex">
                                ...
                                <div class="wd-100p">
                                    <div class="d-flex mb-4"><a href="#"><img
                                                src="{{ asset('assets/img/brand/Logo_Black.png') }}"
                                                    ...
                                                    <div class="tabs-menu1">
                                                        <ul class="nav panel-tabs">
                                                            <li class="me-2"><a href="#tab5" class="active"
                                                                    data-bs-toggle="tab">Admin Login</a></li>
                                                ...
                                                <div class="panel-body tabs-menu-body border-0 p-3">
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="tab6">
                                                            <div id="mobile-num"
                                                                class="wrap-input100 validate-input input-group mb-2">
                                                            ...
                                                            <div class="container-login100-form-btn mt-3">
                                                                <a href="javascript:void(0);"
                                                                    class="btn login100-form-btn btn-primary"
                                                                    id="generate-otp">
                                                                    Proceed
                                                                </a>
                                                            </div>
