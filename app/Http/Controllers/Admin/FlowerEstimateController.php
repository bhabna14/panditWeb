...
class FlowerEstimateController extends Controller
{
 public function index(Request $request)
    ...
    /**
     * /admin/reports/tomorrow-flower
     * PURE "TOMORROW" ESTIMATE PAGE
     * - No filters
     * - Full breakdown only for Carbon::tomorrow()
     */
    ...
    /**
     * /admin/reports/flower-package
     * PACKAGE-LEVEL VIEW
     * - Uses filters (start/end, preset, mode)
     * - Shows per-day or per-month breakdown by PACKAGE
     * - Also has Tomorrow's per-product disclosure at the bottom
     */
