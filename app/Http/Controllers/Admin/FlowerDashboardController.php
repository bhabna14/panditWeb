...
class FlowerDashboardController extends Controller
{
    ...
    public function liveTodayMetrics(): JsonResponse
    {
        ...
        // Customize Orders today
        $ordersRequestedToday = FlowerRequest::whereDate('created_at', $today)->count();

        // New subscriptions today (NEW users only)
        $newUserSubscription = Subscription::where('status', 'pending')
        ...
        // Renewed subscriptions today (per your existing logic)
