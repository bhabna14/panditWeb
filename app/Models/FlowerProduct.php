...
class FlowerProduct extends Model
{
    ...
    protected $fillable = ['product_id','name','odia_name','product_image', 'price','mrp', 'description', 'category','mala_provided', 'is_flower_available','stock', 'duration','benefits','status'];
