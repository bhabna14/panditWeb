...
Route::post('/admin/flower-pickups', [FlowerPickupAssignController::class, 'saveFlowerPickupAssignRider'])
    ...
    Route::get('/admin/flower-item-calculation', [FlowerPickupAssignController::class, 'itemCalculation'])->name('admin.pickups.manage');
...
Route::prefix('admin')->as('admin.')->group(function () {
    ...
    Route::get('/admin/rider-attendance-manual', [RiderAttendanceController::class, 'index'])->name('admin.rider-attendance.manual');
